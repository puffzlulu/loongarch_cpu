...
parameter BASE_RAM_INIT_FILE = "C:/Users/86137/Downloads/matrix.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
parameter EXT_RAM_INIT_FILE = "C:/Users/86137/Downloads/supervisor_la (4)/supervisor_la/utility/matrix.in";    //ExtRAM初始化文件，请修改为实际的绝对路径
